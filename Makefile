...
PROJECT_REPO ?= github.com/siredmar/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= v1.27.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-auth0
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/auth0/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/$(TERRAFORM_PROVIDER_VERSION)/
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-auth0_1.27.0
